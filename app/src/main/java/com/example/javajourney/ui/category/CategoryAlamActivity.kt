...
class CategoryAlamActivity : AppCompatActivity() {
    ...
    private fun fetchCategoryAlamData() {
        ...
        val call = apiService.getCategoryAlam("Wisata Alam")
        ...
        call.enqueue(object : Callback<GetPlace> {
            override fun onResponse(call: Call<GetPlace>, response: Response<GetPlace>) {
                ...
                if (response.isSuccessful) {
                    ...
                    if (places != null && places.isNotEmpty()) {
                        ...
                        Toast.makeText(this@CategoryAlamActivity, "No places found", Toast.LENGTH_SHORT).show()
                    }
                } else {
                    val errorBody = response.errorBody()?.string()
                    Log.d("CategoryAlamActivity", "Failed to retrieve data: $errorBody")
                    Toast.makeText(this@CategoryAlamActivity, "Failed to retrieve data", Toast.LENGTH_SHORT).show()
                }
            }
            ...
            override fun onFailure(call: Call<GetPlace>, t: Throwable) {
                ...
                Toast.makeText(this@CategoryAlamActivity, "Request failed: ${t.message}", Toast.LENGTH_SHORT).show()
            }
        })
    }
}
